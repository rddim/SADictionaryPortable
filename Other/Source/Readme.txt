...
user in an INI file next to SADictionaryPortable.exe called SADictionaryPortable.ini.
...
copy AppNamePortable.ini from this directory to SADictionaryPortable.ini next to
SADictionaryPortable.exe. The options in the INI file are as follows:
